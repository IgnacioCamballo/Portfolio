...
export default function ExpoIcon({width, height}: Icon) {
  return (
    <div className={styles.techCont}>
      <svg width={width} height={height} fill="#000000" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
      ...
      <p className={styles.techName}>Expo</p>
    </div>
  )
}