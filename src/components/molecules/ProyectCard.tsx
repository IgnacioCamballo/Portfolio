...
export default function ProyectCard({name, title, img, description, web, gitHub, googlePlay}: ProyectCardProps) {
  ...
  return (
    <div className={styles.card} onClick={() => setModalProyect(true)}>
      ...
      <div className={styles.card_buttons}>
        {!web || web !== "" && (
          <a href={web} target="_blank" className={`${styles.card_website} ${styles[name]}`}>
            {lenguage("website")}
          </a>
        )}
        {!gitHub || gitHub !== "" && (
